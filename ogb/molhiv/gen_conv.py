...
from torch.nn import Sequential, Linear, ReLU, Dropout, PReLU
...
class GENConv(MessagePassing):
    ...
    def __init__(self, in_channels: int, out_channels: int,
                 ...
                 p: float = 1.0, learn_p: bool = False, msg_norm: bool = True,
        ...
        if learn_p:
            ...
            self.p = p
        self.attention = MultiheadAttention(in_channels, 16, encode_dim=128)
